const lang_zho_Hans = {
    ...
    editor: {
        ...
        log: {
            ...
            broadcast: {
                ...
                ping_server_custom_name: "有其他服务端加入频道，识别名：{name}（{uuid}）",
        ...
        tip: {
            ...
            press_key_to_next_page: "按下 {key} 键向后翻页",
            press_key_to_prev_page: "按下 {key} 键向前翻页"
        }
    },
    effect: {
        print: {
    ...
    emoji: {
        ...
        material: {
            icon: {
                ...
                author: {
                    pictogrammers: "Pictogrammers 社区贡献者"
                },
                emoji: {
                    alert: "警告",
                    arrow_down: "向下箭头",
                    ...
                    hand_pointing_left: "指左侧",
                    hand_pointing_right: "指右侧",
                    ...
                    volume_high: "扬声器",
                    water: "水滴",
                    weather_hurricane: "飓风",
                    weather_night: "月亮",
                    weather_pouring: "雨",
                    weather_tornado: "龙卷风",
                    weather_windy: "风",
                    wheelchair_accessibility: "轮椅",
                    white_balance_sunny: "太阳"
                },  
                group: {
                    animal: "动物",
                    emoticon: "表情",
    ...
    settings: {
        ...
        msgbox: {
            ...
            extension: {
                title: "扩展功能已初步实现",
                description: "扩展管理器目前尚未完成，您可以通过编辑根目录中的 extensions.js 来选择载入哪些扩展。extensions 文件夹中已有一个示例扩展以供参考。"
            }
        },
        tabpage: {
            edit: {
