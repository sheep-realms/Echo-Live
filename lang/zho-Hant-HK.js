const lang_zho_Hant_HK = {
    ...
    config: {
        ...
        echolive: {
            ...
            typing: {
                ...
                enable: {
                    _title: "啓用輸入提示",
                    _description: "啓用後，當編輯器正在輸入時，對話框底部的控制欄會被替換為輸入提示消息。<br>關閉控制欄不會影響此功能。"
                },
                username_enable: {
                    _title: "顯示説話人",
                    _description: "在輸入提示消息中顯示説話人，這在多人聯動時很有用。"
                },
                max_username_length: {
                    _title: "説話人最大長度",
    ...
    editor: {
        ...
        tip: {
            ...
            press_key_to_next_page: "按下 {key} 鍵向後翻頁",
            press_key_to_prev_page: "按下 {key} 鍵向前翻頁"
        }
    },
    effect: {
        print: {
    ...
    emoji: {
        ...
        material: {
            icon: {
                ...
                author: {
                    pictogrammers: "Pictogrammers 社區貢獻者"
                },
                emoji: {
                    alert: "警告",
                    arrow_down: "向下箭頭",
                    ...
                    hand_clap: "拍手",
                    hand_front_left: "左手掌",
                    hand_front_right: "右手掌",
                    hand_okay: "OK",
                    hand_peace: "V字手",
                    hand_pointing_down: "指下方",
                    hand_pointing_left: "指左側",
                    hand_pointing_right: "指右側",
                    hand_pointing_up: "指上方",
                    hand_wash: "洗手液",
                    hand_water: "洗手",
                    hand_wave: "招手",
                    heart: "愛心",
                    ...
                    volume_high: "揚聲器",
                    water: "水滴",
                    weather_hurricane: "颶風",
                    weather_night: "月亮",
                    weather_pouring: "雨",
                    weather_tornado: "龍捲風",
                    weather_windy: "風",
                    wheelchair_accessibility: "輪椅",
                    white_balance_sunny: "太陽"
                },  
                group: {
                    animal: "動物",
                    emoticon: "表情",
    ...
    notice: {
        ...
        config_loaded: "配置文件已載入！請注意，配置文件尚未保存。",
    ...
    settings: {
        ...
        msgbox: {
            ...
            old_version_abandoned_config: "這些配置項僅在舊版本中發揮最大作用，出於兼容考慮仍然保留。它們已被新功能取代，不再能很好地發揮作用。這些配置項在未來可能會被刪除。",
            echo: {
                title: "關於 Echo",
    ...
    typing: {
        ...
        label: {
            generating: {
                ...
                user_multi: "{user}、{user2} 等 {n} 位智能體正在生成回覆"
            },
            rolling_keyboard: {
                no_username: "正在滾鍵盤",
                user_1: "{user} 正在滾鍵盤",
            ...
            searching: {
                no_username: "正在聯網搜索",
                user_1: "{user} 正在聯網搜索",
                user_2: "{user} 和 {user2} 正在聯網搜索",
                user_multi: "{user}、{user2} 等 {n} 位智能體正在聯網搜索"
            },
            thinking: {
                no_username: "正在思考",
                user_1: "{user} 正在思考",
            ...
            transmission: {
                no_username: "正在傳輸信息",
                user_1: "{user} 正在傳輸信息",
                user_2: "{user} 和 {user2} 正在傳輸信息",
                user_multi: "{user}、{user2} 等 {n} 人正在傳輸信息"
            },
            typing: {
                no_username: "正在輸入",
                user_1: "{user} 正在輸入",
    ...
    updater: {
        ...
        notice_title: "發現更新：{version}",
        notice_title_experimental: "發現實驗性更新：{version}",
        notice_title_important: "發現重要更新：{version}",
        notice_title_incremental: "發現增量更新：{version}",
        notice_title_optimization: "發現優化更新：{version}",
