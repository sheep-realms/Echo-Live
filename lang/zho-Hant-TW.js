const lang_zho_Hant_TW = {
    ...
    config: {
        ...
        echolive: {
            ...
            typing: {
                ...
                max_username_length: {
                    _title: "說話人最大長度",
                    _description: "說話人名稱的最大長度，超出此長度的部分會被截斷。<br>設為 0 禁用此限制。"
                },
                label: {
                    _title: "訊息內容",
    ...
    emoji: {
        ...
        material: {
            icon: {
                ...
                author: {
                    pictogrammers: "Pictogrammers 社羣貢獻者"
                },
                emoji: {
                    alert: "警告",
                    arrow_down: "向下箭頭",
    ...
    settings: {
        ...
        msgbox: {
            ...
            extension: {
                title: "擴充套件功能已初步實現",
                description: "擴充套件管理器目前尚未完成，您可以透過編輯根目錄中的 extensions.js 來選擇載入哪些擴充套件。extensions 資料夾中已有一個示例擴充套件以供參考。"
            }
        },
        tabpage: {
            edit: {
